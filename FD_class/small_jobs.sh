...
do
  ...
  echo "n256"
    # 20% of CFL limit
    srun -N 8 -n 256 ./driver -gmres 0 -c 1.600 -o 1 -Pt 32 -Px 8 -nt 500 -nx 500 >> ./results/n256_o1_low.txt
    srun -N 8 -n 256 ./driver -gmres 0 -c 0.989 -o 2 -Pt 32 -Px 8 -nt 500 -nx 500 >> ./results/n256_o2_low.txt
    srun -N 8 -n 256 ./driver -gmres 0 -c 1.744 -o 4 -Pt 32 -Px 8 -nt 500 -nx 500 >> ./results/n256_o4_low.txt
  
    # 70% of CFL limit
    srun -N 8 -n 256 ./driver -gmres 0 -c 5.600 -o 1 -Pt 32 -Px 8 -nt 500 -nx 500 >> ./results/n256_o1_high.txt
    srun -N 8 -n 256 ./driver -gmres 0 -c 3.461 -o 2 -Pt 32 -Px 8 -nt 500 -nx 500 >> ./results/n256_o2_high.txt
    srun -N 8 -n 256 ./driver -gmres 0 -c 6.104 -o 4 -Pt 32 -Px 8 -nt 500 -nx 500 >> ./results/n256_o4_high.txt
